...
export default function RegisterPatientPage() {
  const { canRegisterPatient } = useRole();
  const navigate = useNavigate();

  // Guard: if no permission, show message
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={set("email")}
                className={inputClass}
                placeholder="patient@example.cm"
              />
            </div>
        ...
        <div>
          ...
          <div>
            ...
            <input
              ...
              onChange={set("primaryFacilityId")}
              className={inputClass}
              placeholder="FAC-001 (defaults to your facility)"
            />
          </div>
        </div>
