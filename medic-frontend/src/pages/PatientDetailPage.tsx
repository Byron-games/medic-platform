  ...
  return (
    <div className="space-y-5 max-w-3xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <button
          onClick={() => navigate(`/appointments/new?patient=${mpiId}`)}
          className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4
            text-left hover:border-[var(--accent)]/50 hover:bg-[var(--bg-primary)]
            transition-colors group"
        >
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-1">
            Schedule in-person or telemedicine
          </p>
        </button>
        <button
          onClick={() => navigate(`/telemedicine/new?patient=${mpiId}`)}
          className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4
            text-left hover:border-[var(--accent)]/50 hover:bg-[var(--bg-primary)]
            transition-colors group"
        >
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-1">
            Jitsi telemedicine session
          </p>
        </button>
        <button
          onClick={() => navigate(`/pharmacy/new?patient=${mpiId}`)}
          className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4
            text-left hover:border-[var(--accent)]/50 hover:bg-[var(--bg-primary)]
            transition-colors group"
        >
