...
public interface MedicalRecordRepository extends JpaRepository<MedicalRecord, Long> {
    ...
    Page<MedicalRecord> findByPatientMpiIdOrderByVisitDateDesc(
        String patientMpiId, Pageable pageable);

    /** Records by patient filtered by type */
    Page<MedicalRecord> findByPatientMpiIdAndRecordTypeOrderByVisitDateDesc(
        String patientMpiId, RecordType recordType, Pageable pageable);

    /** Records authored by a specific clinician */
    Page<MedicalRecord> findByClinciianIdOrderByVisitDateDesc(
        Long clinicianId, Pageable pageable);

    /** Records at a specific facility */
    Page<MedicalRecord> findByFacilityIdOrderByVisitDateDesc(
    ...
    List<MedicalRecord> findSharedInRange(
    ...
    List<MedicalRecord> findRecentByPatient(
        @Param("mpiId") String mpiId, Pageable pageable);
}
